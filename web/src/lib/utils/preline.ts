export const getPrelineSelectConfig = ({
  ...
  return {
    ...
    <button type="button" aria-expanded="false">
      <span class="order-1 text-text-dark" data-title></span>
    ...
    optionClasses:
      "py-2 px-4 w-full text-text-dark cursor-pointer hover:bg-slate-50 focus:outline-none focus:bg-gray-100",
    optionTemplate:
